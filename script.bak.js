...
// Tambahkan event listener pada ikon pencarian
searchIcon.addEventListener("click", function() {
    // Toggle visibility dari search bar
    if (searchBar.style.display === "none" || searchBar.style.display === "") {
        searchBar.style.display = "flex"; // Menampilkan search bar

        // Fokuskan cursor pada input field setelah search bar muncul
        searchBox.focus();
    } else {
        searchBar.style.display = "none"; // Menyembunyikan search bar
    }
});

document.addEventListener("DOMContentLoaded", function() {

    // Ambil elemen form dan respon message
    ...
    feedbackForm.addEventListener("submit", function(e) {
        ...
        // Anda bisa menambahkan validasi dan pengiriman data ke server di sini

        // Menampilkan pesan terima kasih setelah submit
        feedbackForm.reset();  // Reset form setelah submit
        feedbackForm.style.display = "none";  // Sembunyikan form
        responseMessage.style.display = "block";  // Tampilkan pesan terima kasih
    });
});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (resepDetail) {
        // Mengisi data ke elemen-elemen yang sesuai
        document.getElementById('recipe-detail').innerText = resepDetail.name;

        // Menampilkan gambar resep
        const recipeImage = document.getElementById('recipe-image'); // Elemen gambar di HTML
        if (recipeImage) {
            recipeImage.src = resepDetail.image; // Set gambar resep
        }
